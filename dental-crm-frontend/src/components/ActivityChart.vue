...
<template>
  <div
    class="bg-card rounded-xl shadow-sm shadow-black/10 dark:shadow-black/40 p-6 space-y-4 h-full"
  >
    ...
    <div v-if="normalizedData.length" class="grid gap-4">
      <div class="flex items-end gap-4 h-48">
        ...
        >
          ...
          <div
            class="w-full h-36 bg-card/60 rounded-lg overflow-hidden flex items-end shadow-sm shadow-black/10 dark:shadow-black/40"
          >
            <div
