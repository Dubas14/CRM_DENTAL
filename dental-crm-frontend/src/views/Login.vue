    ...
    <div class="relative w-full max-w-md">
      <div class="rounded-2xl bg-card/70 border border-border/60 p-6 shadow-2xl backdrop-blur">
        ...
        <form class="space-y-4" @submit.prevent="handleSubmit">
            ...
            <div class="relative">
              ...
              >
                ...
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  ...
                  <path d="M9.88 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a18.16 18.16 0 0 1-3.22 4.4"></path>
          ...
          <!-- Error -->
          <div v-if="error" class="rounded-xl border border-red-500/30 bg-red-500/10 px-3 py-2 text-sm text-red-200">
            ❌ {{ error }}
          </div>
